...
import QRCode from "react-qr-code"; // Add this for authentication
import {
  FileText,
  Filter,
  Printer,
...
const ReportsPage: React.FC = () => {
  ...
  // Unique Report ID for the Barcode/QR
  const reportId = useMemo(
    () =>
      `ORHC-${new Date().getFullYear()}-${Math.floor(1000 + Math.random() * 9000)}`,
    [],
  );
    ...
    <div className="p-6 md:p-10 bg-[#F4F7F6] min-h-screen font-sans text-slate-900">
      ...
      <div className="max-w-[1400px] mx-auto no-print">
        ...
        <div className="bg-white/80 backdrop-blur-md sticky top-6 z-20 border border-slate-200 p-4 rounded-[2.5rem] shadow-xl flex flex-wrap gap-4 items-center mb-12">
          ...
          <select
            ...
            className="flex-1 min-w-[180px] bg-transparent text-sm font-bold p-2 outline-none cursor-pointer"
          >
          ...
          <select
            ...
            className="flex-1 min-w-[150px] bg-transparent text-sm font-bold p-2 outline-none cursor-pointer"
          >
      ...
      <div className="max-w-[1200px] mx-auto overflow-hidden print:p-0">
        <div ref={reportRef} className="bg-white p-10 print-container relative">
          {/* WATERMARK FOR ORIGINALITY (Optional) */}
                  ...
                  <div className="flex items-center justify-between border-b-[6px] border-slate-900 pb-8 mb-8">
                    <div className="flex items-center gap-8">
                      ...
                      <div className="flex-1">
                        <h1 className="text-1xl font-black text-slate-900 leading-tight uppercase">
                  ...
                  <div className="flex justify-between items-end border-t border-slate-300 pt-8">
                    <div className="max-w-[300px]">
                      ...
                      <p className="text-[8px] text-slate-500 leading-relaxed italic">
                        This report is an official extract from the URITHI
                        Electronic Case Management System. Any alteration to
                        this document is a criminal offense under the Computer
                    ...
                    <div className="text-right flex flex-col items-end">
                      <div className="relative mb-1">
                        {/* THE DIGITAL SIGNATURE "HANDWRITTEN" OVERLAY */}
      ...
      {/* IMPORTING A GOOGLE SIGNATURE FONT */}
      <style>{`
