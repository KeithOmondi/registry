  ...
  return (
    <div className="p-4 md:p-8 bg-[#F9F9F7] min-h-screen font-sans">
      ...
      <div className="max-w-[1800px] mx-auto mb-6">
        <div
          className={`relative flex flex-wrap lg:flex-nowrap items-center gap-3 p-3 rounded-2xl border transition-all duration-500 ${
            selectedIds.length > 0
              ? "bg-[#004832] border-[#004832] shadow-2xl"
        ...
        >
          ...
          <div className="relative flex-1 min-w-[320px]">
            ...
            <input
              ...
              className={`w-full pl-12 pr-4 py-3 text-sm font-medium rounded-xl outline-none transition-all ${
                selectedIds.length > 0
                  ? "bg-white/10 text-white placeholder:text-white/30 focus:bg-white/20"
          ...
          <div className="relative w-full lg:w-80">
            ...
            <input
              ...
              className={`w-full pl-12 pr-10 py-3 text-sm font-bold rounded-xl outline-none cursor-pointer transition-all ${
                selectedIds.length > 0
                  ? "bg-white/10 text-white placeholder:text-white/30 focus:bg-white/20"
                  : "bg-slate-50 text-slate-900 placeholder:text-slate-400 focus:bg-white focus:ring-2 focus:ring-[#004832]/5"
              }`}
          ...
          {selectedIds.length > 0 && (
            <div className="flex items-center gap-3 pl-4 border-l border-white/20 animate-in slide-in-from-right-4 duration-500">
              <div className="flex flex-col">
                <span className="text-[9px] font-black text-[#C8A239] uppercase tracking-tighter">
                  Action Date
                </span>
                <input
                  type="date"
                  className="bg-white/10 text-white text-xs rounded-lg px-3 py-1.5 border border-white/10 outline-none focus:border-[#C8A239]"
                  value={bulkDate}
              ...
              <button
                ...
                className="bg-[#C8A239] hover:bg-white text-[#004832] text-[10px] font-black uppercase px-6 py-3 rounded-xl transition-all shadow-lg flex items-center gap-2"
              >
                <Send size={14} /> Forward to GP
              </button>
              <button
            ...
            <tbody className="divide-y divide-slate-50">
              {currentRecords.map((r) => (
                ...
                >
                  ...
                  <td className="p-6 font-black uppercase text-slate-800 tracking-tight">
                    {r.nameOfDeceased}
                  </td>
                  ...
                  <td className="p-6 text-right">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <button
                        ...
                        className="p-3 bg-white hover:bg-[#004832] text-[#004832] hover:text-white rounded-2xl transition-all shadow-sm border border-slate-100"
                      >
                        <Edit3 size={16} />
                      </button>
                      ...
                      <div className="relative group/audit">
                        ...
                        <div className="absolute bottom-full right-0 mb-4 hidden group-hover/audit:block w-72 bg-[#1a1a1a] text-white p-5 rounded-[2rem] shadow-2xl z-[150] border border-white/10 backdrop-blur-md animate-in fade-in slide-in-from-bottom-2">
                          <div className="space-y-4">
                            <div className="flex items-center justify-between border-b border-white/10 pb-2">
                              <h4 className="text-[10px] font-black text-[#C8A239] uppercase tracking-[0.2em]">
                                Audit Log
                              </h4>
                              <div className="h-2 w-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]" />
                            </div>
                            <div className="flex justify-between text-[11px]">
                              <span className="text-slate-500 uppercase font-black tracking-tighter text-[9px]">
                                Officer
                              </span>
