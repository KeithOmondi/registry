  ...
  return (
    <>
      ...
      >
        {/* Header Logo */}
        <div
          className={`h-24 flex items-center border-b border-white/5 overflow-hidden ${
        ...
        >
          <div className="flex items-center gap-4">
            <div className="min-w-[48px] h-12 bg-[#b48222] rounded-2xl flex items-center justify-center shadow-lg transform rotate-3 flex-shrink-0">
              <span className="text-white font-black text-2xl -rotate-3">
                J
              </span>
            </div>
            {isOpen && (
        ...
        >
          <div
            className={`bg-emerald-900/40 rounded-2xl border border-white/5 relative overflow-hidden transition-all ${
              isOpen ? "p-4" : "p-3"
            }`}
          >
